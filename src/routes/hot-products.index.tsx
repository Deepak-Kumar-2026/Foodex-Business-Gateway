...
// import { HotProductCard, SpecTable, ProductActions } from "@/components/ProductCard";
// import { countries } from "@/data/locations";
// import { company } from "@/data/company";
// import { useLang } from "@/lib/i18n";

// const title = "Hot Products | Batch Fryers, Extruders & Soya Nugget Plant";
// const description =
...
//       { name: "keywords", content: hotProducts.flatMap((p) => p.keywords).join(", ") },
//       { property: "og:title", content: title },
//       { property: "og:description", content: description },
//       { property: "og:type", content: "website" },
//       { property: "og:url", content: abs("/hot-products") },
//       { property: "og:image", content: abs(hotProducts[0]!.image) },
//       { name: "twitter:image", content: abs(hotProducts[0]!.image) },
//     ],
//     links: [{ rel: "canonical", href: abs("/hot-products") }],
//     scripts: [
//       {
...
//             <Flame className="h-4 w-4" /> {t("label.hotProduct")}
//           </p>
...
//             Nine flagship machine lines engineered by {company.name}, Ghaziabad. Select any product to view its
//             complete technical matrix, applications and FAQs.
//           </p>
//         </div>
//       </section>
...
//                   active.slug === p.slug ? "border-primary bg-card shadow-card" : "border-border bg-card/60 hover:border-primary/60"
//                 }`}
//               >
//                 <img src={p.image} alt={p.title} loading="lazy" width={1024} height={768} className="h-14 w-20 shrink-0 rounded object-cover" />
//                 <span className="min-w-0">
//                   <span className="block truncate text-sm font-bold">{p.title}</span>
//                   <span className="mt-0.5 flex flex-wrap items-center gap-1">
//                     <span className="rounded bg-primary px-1.5 py-0.5 text-[10px] font-bold text-primary-foreground">{p.capacity}</span>
...
//                       <Flame className="h-2.5 w-2.5" /> {t("label.hotProduct")}
//                     </span>
//                   </span>
//                 </span>
//               </button>
...
//             />
//             <h2 className="mt-6 font-display text-2xl font-extrabold">{active.title}</h2>
//             <p className="mt-2 text-sm text-muted-foreground">{active.summary}</p>

//             <h3 className="mt-6 font-display text-lg font-bold">{t("label.specs")}</h3>
//             <div className="mt-2 card-surface p-4">
//               <SpecTable specs={active.specs} />
//             </div>

//             <h3 className="mt-6 font-display text-lg font-bold">{t("label.features")}</h3>
...
//             <h3 className="mt-6 font-display text-lg font-bold">{t("label.applications")}</h3>
...
//             <h3 className="mt-6 font-display text-lg font-bold">{t("label.faq")}</h3>
...
//               <h3 className="font-display text-base font-bold">Target Market Directory</h3>
...
//         <div className="mx-auto max-w-7xl px-4">
//           <h2 className="font-display text-2xl font-extrabold">All Hot Products</h2>
