...
p(
  ...
  "Twin screw food extruder designed for producing pasta, pet food, breakfast cereal, snacks, pellet feed and soya nuggets.",
  "100 kg/hr",
  "75 kW",
  "Automatic",
  ...
  [
    ...
    { label: "Application", value: "Pasta, Pet food, Breakfast cereal, Snacks, Pellet feed, Soya nuggets" },
  ...
  [
    ...
    "Manual die change",
    "Suitable for multiple food and feed applications",
  ],
  ...
  [
    {
      q: "What is the extruder type?",
      a: "The extruder type is Twin screw.",
    },
    {
      q: "What is the output capacity?",
      a: "The output capacity is 100 kg/hr.",
    },
    {
      q: "What is the drive power?",
      a: "The drive power is 75 kW.",
    },
    {
      q: "What heating system is used?",
      a: "The heating type is Electric heaters.",
    },
    {
      q: "How is the die changed?",
      a: "The machine uses a Manual change die system.",
    },
    {
      q: "What products can be produced?",
      a: "The listed applications include Pasta, Pet food, Breakfast cereal, Snacks, Pellet feed and Soya nuggets.",
    },
  ]
),
p(
...

{
  ...
  products: [
    ...
    p(
  "Potato Starch Recovery Plant",
  "/images/machines/Starch Processing Plant/2.webp",
  "Automatic potato starch recovery plant designed for dry process potato starch production with SS 304 construction and 30 kg/hr capacity.",
  "30 kg/hr",
  "15 kW",
  "Automatic",
  ...
  [
    { label: "Automation Grade", value: "Automatic" },
    { label: "Operation Mode", value: "Automatic" },
    { label: "Starch Type", value: "Potato starch" },
    { label: "Material Processed", value: "Potato" },
    { label: "Raw Material", value: "Potato" },
    { label: "Processing Method", value: "Dry Process" },
    { label: "Capacity", value: "30 kg/hr" },
    { label: "Electricity Connection", value: "Three Phase" },
    { label: "Total Capacity", value: "30 KG HRS" },
    { label: "Material of Construction (Contact)", value: "SS 304" },
    { label: "Motor Power", value: "15 HP" },
    { label: "Power (kW)", value: "15 KW" },
    { label: "Power", value: "200 kw" },
    { label: "Power Consumption", value: "10000 W" },
    { label: "Brand", value: "FOODAX" },
  ...
  [
    ...
    "380–440 V operation",
    "Designed for potato starch processing",
  ...
  [
    {
      q: "What is the capacity of the Potato Starch Recovery Plant?",
      a: "The listed capacity is 30 kg/hr.",
    },
    {
      q: "What type of starch is produced?",
      a: "The listed starch type is Potato starch.",
    },
    {
      q: "What material is processed?",
      a: "The material processed and raw material are Potato.",
    },
    {
      q: "What processing method is used?",
      a: "The listed processing method is Dry Process.",
    },
    {
      q: "Is the plant automatic?",
      a: "Yes, the automation grade and operation mode are Automatic.",
    },
    {
      q: "What is the motor power?",
      a: "The listed motor power is 15 HP.",
    ...
    {
      q: "What material is used for construction?",
      a: "The construction material is SS 304.",
    },
    {
      q: "What is the power consumption?",
      a: "The listed power consumption is 10000 W.",
    },
    {
      q: "What is the voltage?",
      a: "The listed voltage is 380–440 V.",
    },
    {
      q: "What is the surface finish?",
      a: "The surface finish is Polished.",
    },
    {
      q: "What is the minimum order quantity?",
      a: "The minimum order quantity is 1 Piece.",
